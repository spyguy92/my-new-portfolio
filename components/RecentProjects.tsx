  ...
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">
        ...
        <span className="text-purple">Recenet projets</span>
      </h1>
        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]" key={id}>
            <PinContainer title={link} href={link}>
                <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidded sm:h-[40vh] h-[30vh] mb-10">
